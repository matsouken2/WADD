...
try:
    ...
    if annualInterestRate < 1 or annualInterestRate > 100:
        raise Exception('interest rate not in the range of 1 to 100')
    ...
    while startingBalance > 0:
        month += 1
        if month > 5:
            raise Exception('max payment number of 5 reached')
        ...
        print("{:<8d}{:>10.2f}{:>10.2f}{:>10.2f}{:>10.2f}{:>10.2f}".format(month, startingBalance, payment,
                                                                           middleBalance, interest, endingBalance))
